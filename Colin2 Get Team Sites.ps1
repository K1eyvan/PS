...
function Get-SiteVisibility {
    ...
    Connect-PnPOnline -Url $SiteUrl -PnPManagementShell -ClientId $ApplicationId -Tenant $tenantID -CertificatePath "path_to_certificate"
...
Foreach ($Team in $Teams){
    ...
    Foreach ($Channel in $Channels)
    {
        ...
        $SiteVisibility = Get-SiteVisibility -SiteUrl $SharePointSiteURL
